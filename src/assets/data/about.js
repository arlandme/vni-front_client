...
export const about = {
  ...
  contents: [
    ...
    'In the past, InsQuality was a professional inspection freelance team with members who have ever worked in Intertek, SGS and Qima. In 2023, HandiPassion merged InsQuality and its QC team into Quality Department of HandiPassion. Handicraft products are manufactured and inspected with the process of strict and flexible control to ensure fewest defects can exist. We have two offices which perfectly support the inspection services and fully cover the northern areas. InsQuality was established to help customers save cost as well as time with professionalism in each service.',
